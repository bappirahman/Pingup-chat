  ...
  return (
    ...
    >
                ...
                <button
                  ...
                  className={`w-full p-4 text-left rounded-lg transition-colors ${
                    isSelected
                      ...
                      : "border border-t-gray-700 hover:border-gray-600"
                  }`}
                >
                  <div className="flex items-center gap-3">
                    <div className="relative">
      ...
      <div className="p-4 border-t border-gray-700 space-y-2">
        ...
        <button
          className="w-full flex items-center justify-start gap-3 px-4 py-3 rounded-lg hover:bg-red-600 transition-colors text-red-500 hover:text-white"
